...
class Contact implements Comparable
{
    ...
    public String toString()
    {
        ...
        //changed to put phone number first becuase it is prioity for sorting
    }
    ...
    //-----------------------------------------------------------------
    // *Changed to prioity phone numbers first*
    //-----------------------------------------------------------------
    public int compareTo(Object other)
    {
        ...
        //If phone # is the same ---> use alphabetically
        if (result == 0)
        {
            if (lastName.equals(otherContact.getLastName()))
            {
                result = firstName.compareTo(otherContact.getFirstName());
            }             
            else 
            {
                result = lastName.compareTo(otherContact.getLastName());
            }
        }                       
        return result;
    }
